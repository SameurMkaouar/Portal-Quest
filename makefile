prog : image.o audio.o text.o hero.o background.o minimap.o ennemi.o main.o
	gcc image.o audio.o text.o hero.o background.o minimap.o ennemi.o main.o -lSDL -lSDL_image -lSDL_ttf -lSDL_mixer -lm -o prog -g
